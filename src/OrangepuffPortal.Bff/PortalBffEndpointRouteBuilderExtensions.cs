...
{
    /// <summary>
    /// Maps Portal's Bff-owned routes: /bff/login, /bff/logout, /bff/me(/permissions), /bff/me/avatar, /bff/users/{id}/avatar, /bff/users/{id}/config, /bff/config-text, and the AdminOnly-gated /bff/admin/* group.
    /// </summary>
